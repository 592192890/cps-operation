...
function MemberDetailContext($state,$stateParams,$cookieStore,$timeout, apiService,webStorageCache,$modal) {
    ...
    this.getPicSrc = function (viewModel) {
...
MemberDetailContext.extend(ContextSupport);
